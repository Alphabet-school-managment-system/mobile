...
import { MaterialParams } from "./materialDetail";
...
export default function Index() {
  ...
  const { material: stringifiedData } = useLocalSearchParams<MaterialParams>();
      ...
      mutate(
        { body: payload },
        {
          onSuccess: () => {
            ...
            router.navigate("/(app)/(learning-material)/myUploads");
          },
        },
      );
    } catch (error) {
